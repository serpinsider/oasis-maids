...
export const LOCATION_DETAILS = {
  'xjkoaljr': { name: 'Oasis Maids', domain: 'oasismaids.com', agent: 'Maria' },
  'default': { name: 'Oasis Maids', domain: 'oasismaids.com', agent: 'Maria' }
};
...
export const PHONE_NUMBERS = {
  'xjkoaljr': '+14076892100',  // Oasis form
  'default': '+14076892100'    // Default to Oasis number
};
