...
export default function HeroSection() {
  ...
  return (
    <section className="relative pt-48 pb-32 lg:pt-64 lg:pb-48 overflow-hidden bg-gradient-to-br from-slate-900 to-slate-800">
      ...
      >
        <source src="/hero-vid-oasis.mp4" type="video/mp4" />
        ...
        <div className={`transition-all duration-700 ease-out ${
          ...
          <div className={`flex-1 text-center lg:text-left transition-all duration-700 ease-out ${
            isFormExpanded 
              ...
              Premium Central Florida House Cleaners
            </h1>
            <p className="text-base sm:text-base lg:text-lg text-gray-100 mb-8 leading-relaxed drop-shadow-md">
              Your trusted cleaning oasis in Orlando, Gainesville & Ocala. Get your free estimate in under 60 seconds.
            </p>
