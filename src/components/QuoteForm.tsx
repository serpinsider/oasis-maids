...
export default function QuoteForm() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const confirmationNumber = 'OASIS-' + Math.random().toString(36).substring(2, 8).toUpperCase();
      ...
      const structuredData = {
        ...
        confirmationNumber,
        _subject: `Quote Request for Oasis Maids from ${formData.firstName} ${formData.lastName} - #${confirmationNumber}`,
      };
        ...
        <div className="lg:col-span-2 bg-slate-800/50 backdrop-blur-md p-8 rounded-xl shadow-xl border border-white/10">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xs text-white/60 text-center mb-4">
              By submitting this form, you agree to receive communications from Oasis Maids regarding your quote request. We respect your privacy and will never share your information.
            </p>
              ...
              <div className="space-y-6">
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <span>(407) 689-2100</span>
                  </a>
                  <a 
                    href="sms:+14076892100" 
                    className="flex items-center space-x-3 text-base text-white/80 hover:text-white transition-colors"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <a 
                    href="mailto:hello@oasismaids.com" 
                    className="flex items-center space-x-3 text-base text-white/80 hover:text-white transition-colors"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
