...
const serviceAreas = [
  'Orlando', 'Gainesville', 'Ocala', 'Winter Park', 'Altamonte Springs', 'Sanford', 'Leesburg', 'Mount Dora'
];

export default function AreasWeServeSection() {

  return (
    <section id="areas" className="py-20" style={{background: 'rgba(31, 31, 31, 0.95)'}}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
                      <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif font-bold text-[#CEC28D] mb-4">
            Central Florida Service Locations
          </h2>
                      <p className="text-sm sm:text-base text-white/70 max-w-3xl mx-auto mb-8">
              Expert residential cleaning available across Orlando, Gainesville, Ocala and surrounding communities.
            </p>
