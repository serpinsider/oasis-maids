...
const reviews = [
  {
    ...
    location: "Orlando, FL",
    rating: 5,
    text: "Best cleaning service in Orlando! My house sparkles every time. Professional, thorough, and always on time.",
    date: "2 days ago",
  ...
  },
  {
    ...
    rating: 5,
    text: "Exceeded expectations! Attention to detail is amazing. Best cleaning service I've used in Gainesville.",
    date: "1 week ago",
...
export default function ReviewsSection() {
  ...
  return (
    <section id="reviews" className="py-20" style={{background: 'rgba(31, 31, 31, 0.9)'}}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
                      <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif font-bold text-[#CEC28D] mb-4">
            Central Florida Client Reviews
          </h2>
                      <p className="text-sm sm:text-base text-white/70 max-w-3xl mx-auto">
              Discover why Central Florida residents choose Oasis Maids for their home cleaning needs.
            </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {reviews.map((review) => (
            <div key={review.id} className="bg-[rgba(31,31,31,0.95)] backdrop-blur-md rounded-xl p-6 shadow-xl border border-white/10 hover:bg-[rgba(31,31,31,0.98)] hover:shadow-2xl hover:shadow-black/30 transition-all">
