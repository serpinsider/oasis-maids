...
export default function Footer() {
  ...
  return (
    <footer className="bg-[rgba(31,31,31,0.98)] text-white">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <div className="space-y-2 text-sm">
              <p className="text-white/80">(407) 689-2100</p>
              <p className="text-white/80">hello@oasismaids.com</p>
              <p className="text-white/80">456 Orange Ave, Orlando, FL 32801</p>
            </div>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-white/60 text-sm">
              © {currentYear} Oasis Maids. All rights reserved.
            </p>
