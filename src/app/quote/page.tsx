...
export const metadata: Metadata = {
  title: 'Get Your Quote | Oasis Maids',
  ...
  openGraph: {
    title: 'Get Your Quote | Oasis Maids',
    description: 'Get an instant quote for your professional home cleaning service. Choose your cleaning type, customize your needs, and let Oasis Maids take care of the rest.',
    url: 'https://oasismaids.com/quote',
  ...
  alternates: {
    canonical: 'https://oasismaids.com/quote',
  },
};
