      ...
      <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-xl shadow-xl border border-white/20 p-8 space-y-8">
          ...
          <section className="mb-12">
            ...
            <p className="text-white/90 mb-4">At Oasis Maids, we stand behind our work with a 100% satisfaction guarantee. If you&apos;re not completely satisfied with our cleaning service, we will:</p>
          ...
          <section className="mb-12">
            ...
            <p className="text-white/90">Email: support@oasismaids.com</p>
            <p className="text-white/90">Phone: (407) 689-2100</p>
          </section>
        </div>
      </div>
    </main>
